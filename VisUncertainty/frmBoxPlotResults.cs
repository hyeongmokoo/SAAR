...
{
    public partial class frmBoxPlotResults : Form
    {
        ...
        public List<object> uvList;
        //public Color pFillColor;
        public double[,] adbQuantiles;
        //public int intNBins;
        ...
        private void exportToImageFileToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            try
            {
